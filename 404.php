		...
		<main id="main" class="site-main">
			...
			<section class="error-404 not-found">
				<header class="page-header">
					<h1 class="page-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'business-craft' ); ?></h1>
				</header><!-- .page-header -->
	 ...
	 <aside id="secondary" class="widget-area">
            	<div class="widget widget_categories">
					...
					<?php
						...
						$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'business-craft' ), convert_smilies( ':)' ) ) . '</p>';
