...
add_action('','business_craft_before_wp_head');
        ...
        if(!is_front_page()){
            ...
            if( !empty( $business_craft_default_layout ) ){
                if( 'left-sidebar' == $business_craft_default_layout ){
                    $business_craft_body_classes[] = 'evision-left-sidebar';
                }
                elseif( 'right-sidebar' == $business_craft_default_layout ){
                    $business_craft_body_classes[] = 'evision-right-sidebar';
                }
                elseif( 'no-sidebar' == $business_craft_default_layout ){
                    $business_craft_body_classes[] = 'evision-no-sidebar';
                }
                else{
                    $business_craft_body_classes[] = 'evision-right-sidebar';
                }
                ...
                $business_craft_body_classes[] = 'business-craft-right-sidebar';
            }
        }
