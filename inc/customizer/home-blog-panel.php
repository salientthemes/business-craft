...
$business_craft_sections['business-craft-home-blog-panel'] =
    array(
        'priority'       =>   310,
        'title'          =>   esc_html__( 'Home Page Blog Section', 'business-craft' ),
   	);
...
$business_craft_settings_controls['business-craft-home-blog-enable'] =
    array(
        ...
        'control' =>   array(
            'label'                 =>    esc_html__( 'Enable Blog Section', 'business-craft' ),
            'description'           =>   esc_html__( 'Enable "Blog Section" on checked' , 'business-craft' ),
...
$business_craft_settings_controls['business-craft-home-blog-title'] =
    array(
        ...
        'control' =>   array(
            'label'                 =>    esc_html__( 'Blog Section Title', 'business-craft' ),
            'section'               =>   'business-craft-home-blog-panel',
            'type'                  =>   'text',
            'priority'              =>   20,
            'active_callback'       =>   ''
...
$business_craft_settings_controls['business-craft-home-blog-category'] =
    array(
        ...
        'control' =>   array(
            'label'                 =>    esc_html__( 'Select Category For Blog', 'business-craft' ),
            'description'           =>    esc_html__( 'Blog will only displayed from this category', 'business-craft' ),
            'section'               =>   'business-craft-home-blog-panel',
    ...
    $business_craft_settings_controls['business-craft-home-blog-button-text'] =
        array(
            ...
            'control' =>   array(
                'label'                 =>    esc_html__( 'Browse All Button Text', 'business-craft' ),
                'section'               =>   'business-craft-home-blog-panel',
                'type'                  =>   'text',
                'priority'              =>   70,
                'active_callback'       =>   ''
    ...
    $business_craft_settings_controls['business-craft-home-blog-button-link'] =
        array(
            ...
            'control' =>   array(
                'label'                 =>    esc_html__( 'Browse All Button Link', 'business-craft' ),
                'section'               =>   'business-craft-home-blog-panel',
                'type'                  =>   'url',
                'priority'              =>   80,
                'active_callback'       =>   ''
