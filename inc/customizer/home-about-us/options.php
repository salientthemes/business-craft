...
$business_craft_customizer_defaults['business-craft-about-us-main-title-text'] = esc_html__('MEET US IN PERSONAL','business-craft');


// create a section for about us
$business_craft_sections['business_craft_about_us_section']  =
	array(
		'title'          	=>esc_html__('About Us Option','business-craft'),
