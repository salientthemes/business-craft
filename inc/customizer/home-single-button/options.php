...
$business_craft_customizer_defaults['business-craft-single-button-text'] = __('I AM GOING BY THIS PRODUCT','business-craft');
...
$business_craft_sections['business-craft-single-button-section'] = 
	array(
		'title'   	=>__('Single Button Option','business-craft'),
...
$business_craft_settings_controls['business-craft-single-button-enable'] = 
	array(
		...
		'control'				=>array(
			'label' 			=>__('Enable Single Button','business-craft'),
...
$business_craft_settings_controls['business-craft-single-button-text'] = 
	array(
		...
		'control'				=>array(
			'label' 			=>__('Button Text Here','business-craft'),
			'section'			=>'business-craft-single-button-section',
			'type'				=>'text',
			'priority'			=>20,
			'active_callback'	=>''	
...
$business_craft_settings_controls['business-craft-single-button-link'] = 
	array(
		...
		'control'				=>array(
			'label' 			=>__('Button Link Here','business-craft'),
			'section'			=>'business-craft-single-button-section',
			'type'				=>'text',
			'priority'			=>30,
			'active_callback'	=>''	
